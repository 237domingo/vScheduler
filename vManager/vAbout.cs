...
namespace vManager
{
    public partial class vAbout : Form
    {
        ...
        private void bn_license_Click(object sender, EventArgs e)
        {
            ...
            vmt.Text = "vManager - License";
            vmt.View(global::vManager.Properties.Resources.License);
        }
        ...
        {
            System.Diagnostics.Process.Start("http://aha-soft.com/support.htm");
        }
        ...
        {
            System.Diagnostics.Process.Start("http://visualpharm.com");
        }
    }
}
